...
class RegexpTerm extends Regexp {
  ...
  public RegularExpression toRegularExpression(RegularGrammar g) {
    switch (regexpType) {
      case GROUP:
        return internal.toRegularExpression(g);
      case OPTIONAL:
        return g.newOption(internal.toRegularExpression(g));
      case CLOSURE:
        return g.newClosure(internal.toRegularExpression(g));
      case PCLOSURE:
        return g.newPositiveClosure(internal.toRegularExpression(g));
      default:

 ...
 */
class SyntacsDefaultDFA extends MesoArrayDFA {
  ...
  static {
    _table =
        Pickler.unpickle2D(
            " 2 $! \u8001\u001f\u8001\u001f     \u0096 ) \u009a     # # #   #                                     #   $ \"                 %       \' \' \' \' \' \' \' \' \' \'   &   (       ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )         )   ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ( * - \" \" 0 \" \" 1 < ) @     # # #   #                                     # _ B | $ $ / $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ $ . $! \u8001\u001f\u8001\u001f     $! \u8001\u001f\u8001\u001f     0 N Y     *   \' \' \' \' \' \' \' \' \' \' $! \u8001\u001f\u8001\u001f     r M \u009a     )     ) ) ) ) ) ) ) ) ) )               ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )         )   ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) . P Y     + + + + + + + + + + 0 N Y     ,   + + + + + + + + + + . P Y     - - - - - - - - - - . P Y     - - - - - - - - - - % * * $ $   $! \u8001\u001f\u8001\u001f     $! \u8001\u001f\u8001\u001f     % * *     0");
    _accepts =
        Pickler.unpickle1D(
            " 2\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f \"\u8001\u001f\u8001\u001f 6 7\u8001\u001f\u8001\u001f 8 3\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f\u8001\u001f 5\u8001\u001f\u8001\u001f 4 !\u8001\u001f\u8001\u001f");
  }
}

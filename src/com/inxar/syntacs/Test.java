...
public class Test
{
	...
	if (idx != argv.length - 1) 
	    usage("The last argument must be the filename or URI of the "+
		  "tests.dtd XML instance.");
	...
	Translator t = ((TranslatorGrammar)Class.forName(className).newInstance())
	    .newTranslator(p);
    ...
    {
	if (log == null)
	    log = Mission.control().log("tst", new Test());
	return log;
    }
	...
	System.err.println("|  <test-filename|uri>...The filename (or URI) of an XML instance of tests.dtd");
	System.err.println("|");	

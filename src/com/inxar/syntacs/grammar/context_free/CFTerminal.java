 ...
 */
public class CFTerminal implements Terminal {
  /**
  ...
  public IntSet getFirstSet() {
    if (first == null) first = new SingletonIntSet(ID);
    return first;
  }
  ...
  public boolean equals(Object other) {
    if (other == null || !(other instanceof Terminal)) return false;
   ...
   */
  static final class GeneralToken implements Token {

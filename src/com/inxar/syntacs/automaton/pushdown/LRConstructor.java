 ...
 */
public abstract class LRConstructor implements DPAConstructor /* , LR0Machine */ {
  /**
  ...
  protected void showCanon(StringBuffer buf) {
    ...
    for (int i = 0; i < len; i++) {
      ...
      buf.append(state.getID()).append(':').append(StringTools.NEWLINE).append(show(state.set));
    }
  }

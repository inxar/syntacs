...
public class Tree 
{
    ...
    {
	if (log == null)
	    log = Mission.control().log("tree", new Tree(""));
	return log;
    }
	...
	private int getMedian()
	{
		...
		if (list == null || list.size() < 2) {
			...
			.write(", ").write(System.identityHashCode(this))
	...
	{
	    log().debug()
		.write("Writing grid for ").write(name)
		.write(", ").write(System.identityHashCode(this))
		.write(", width ").write(width)
		.write(", pivot ").write(pivot)
		.write(", median ").write(median)
		.write(", xoff ").write(xoff)
		.write(", yoff ").write(yoff)
		.out();
		...
		log().debug()
		    .write("In ").write(name)
		    .write(", ").write(System.identityHashCode(this))
		    .write(", box width ").write(bw)
		    .write(", box median ").write(bm)
		    .out();

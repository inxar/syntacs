...
public class BubbleTree
{
	...
	*/
	...
	void put(int that_lo, int that_hi, IntSet other)
	{
	    ...
	    //
	    if (this.lo > that_hi) {
		if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") TRINITY LEFT "+this);
		...
		if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") TRINITY RIGHT "+this);
		...
		//
		if (this.lo > that_lo) {
		    if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") LOW SUPERCLUSION "+this);
		...
		//
                    ...
                    // remerge.
                    if (setsAreNotEqual) {
			if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") LOW SUBCLUSION "+this);
		...
		//
		if (this.hi < that_hi) {
		    if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") HIGH SUPERCLUSION "+this);
		...
		//
                    ...
                    // remerge.
                    if (setsAreNotEqual) {
			if (DEBUG) System.out.println("("+that_lo+","+that_hi+","+other+") HIGH SUBCLUSION "+this);

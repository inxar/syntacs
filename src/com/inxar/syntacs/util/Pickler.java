...
public class Pickler {
  ...
  private static int[][] unpickle2D(Pickle src) {
    ...
    // Iterate the expected length
    for (int i = 0; i < len; i++) dst[i] = unpickle1D(src, i);
  ...
  private static int[][][] unpickle3D(Pickle src) {
    ...
    // Iterate the expected length
    for (int i = 0; i < len; i++) dst[i] = unpickle2D(src);
  ...
  private static final class Pickle {
    ...
    Pickle(String[] src) {
      ...
      for (int i = 0; i < src.length; i++) b.append(src[i]);
  ...
  private static String string2() {
    ...
    StringBuffer b = new StringBuffer();
    for (int i = 0; i < 10; i++) b.append(msg);
